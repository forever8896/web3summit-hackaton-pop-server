...
mod my_erc20 {
    ...
    impl MyErc20 {
        ...
        #[ink(message)]
        pub fn approve(&mut self, spender: H160, value: U256) -> Result<()> {
        ...
        #[ink(message)]
        pub fn transfer_from(&mut self, from: H160, to: H160, value: U256) -> Result<()> {
            let caller = self.env().caller();
    ...
    mod tests {
        ...
        fn new_works() {
            ...
            let _my_erc20 = MyErc20::new(100.into());
        ...
        fn total_supply_works() {
            // Constructor works.
            set_caller(H160::from([0x01; 20]));
            let my_erc20 = MyErc20::new(100.into());
            // Transfer event triggered during initial construction.
            let emitted_events = ink::env::test::recorded_events().collect::<Vec<_>>();
            assert_transfer_event(
                &emitted_events[0],
            ...
            assert_eq!(my_erc20.total_supply(), U256::from(100));
        }
        ...
        fn balance_of_works() {
            ...
            assert_eq!(my_erc20.balance_of(accounts.alice), U256::from(100));
            // Bob does not owns tokens
            assert_eq!(my_erc20.balance_of(accounts.bob), U256::zero());
        }
        ...
        fn transfer_works() {
            ...
            // Constructor works.
            let mut my_erc20 = MyErc20::new(100.into());
            // Transfer event triggered during initial construction.
            assert_eq!(my_erc20.balance_of(accounts.bob), U256::zero());
            // Alice transfers 10 tokens to Bob.
            assert_eq!(my_erc20.transfer(accounts.bob, U256::from(10)), Ok(()));
            // Bob owns 10 tokens.
            assert_eq!(my_erc20.balance_of(accounts.bob), U256::from(10));
        ...
        fn invalid_transfer_should_fail() {
            ...
            let mut my_erc20 = MyErc20::new(initial_supply);
            ...
            assert_eq!(
                my_erc20.transfer(accounts.eve, 10.into()),
                Err(Error::InsufficientBalance)
            );
            // Alice owns all the tokens.
            assert_eq!(my_erc20.balance_of(accounts.alice), U256::from(100));
            assert_eq!(my_erc20.balance_of(accounts.bob), U256::zero());
            assert_eq!(my_erc20.balance_of(accounts.eve), U256::zero());
        ...
        fn transfer_from_works() {
            ...
            assert_eq!(
                my_erc20.transfer_from(accounts.alice, accounts.eve, 10.into()),
                Err(Error::InsufficientAllowance)
            );
            // Alice approves Bob for token transfers on her behalf.
            assert_eq!(my_erc20.approve(accounts.bob, 10.into()), Ok(()));
            ...
            // Eve owns tokens.
            assert_eq!(my_erc20.balance_of(accounts.eve), U256::from(10));
        ...
        fn allowance_must_not_change_on_failed_transfer() {
            ...
            // Alice approves Bob for token transfers on her behalf.
            let alice_balance = my_erc20.balance_of(accounts.alice);
            let initial_allowance = alice_balance + 2;
            assert_eq!(my_erc20.approve(accounts.bob, initial_allowance), Ok(()));
            ...
            assert_eq!(
                my_erc20.allowance(accounts.alice, accounts.bob),
                initial_allowance
            );
    ...
    mod e2e_tests {
        ...
        async fn e2e_transfer<Client: E2EBackend>(mut client: Client) -> E2EResult<()> {
            ...
            let mut constructor = MyErc20Ref::new(total_supply);
            let my_erc20 = client
                .instantiate("my_erc20", &ink_e2e::alice(), &mut constructor)
                .submit()
                .await
                .expect("instantiate failed");
            let mut call_builder = my_erc20.call_builder::<MyErc20>();
        ...
        async fn e2e_allowances<Client: E2EBackend>(mut client: Client) -> E2EResult<()> {
            ...
            let mut constructor = MyErc20Ref::new(total_supply);
            let my_erc20 = client
                .instantiate("my_erc20", &ink_e2e::bob(), &mut constructor)
                .submit()
                .await
                .expect("instantiate failed");
            let mut call_builder = my_erc20.call_builder::<MyErc20>();
